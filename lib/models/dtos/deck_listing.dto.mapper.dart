...
class DeckListingMapper extends ClassMapperBase<DeckListing> {
  ...
  static const Field<DeckListing, int> _f$favoritesCount = Field(
    'favoritesCount',
    _$favoritesCount,
    key: r'favorites_count',
    opt: true,
    def: 0,
  );
  static int _$forksCount(DeckListing v) => v.forksCount;
  static const Field<DeckListing, int> _f$forksCount = Field(
    'forksCount',
    _$forksCount,
    key: r'forks_count',
    opt: true,
  ...
  static const Field<DeckListing, List<String>> _f$featuredImages = Field(
    'featuredImages',
    _$featuredImages,
    key: r'featured_images',
    opt: true,
    def: const [],
  );
  static DateTime _$updatedAt(DeckListing v) => v.updatedAt;
  static const Field<DeckListing, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
  );
  static DateTime _$createdAt(DeckListing v) => v.createdAt;
  static const Field<DeckListing, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  ...
  static const Field<DeckListing, String> _f$deckId = Field(
    'deckId',
    _$deckId,
    key: r'deck_id',
  );
...
mixin DeckListingMappable {
  String toJson() {
    return DeckListingMapper.ensureInitialized().encodeJson<DeckListing>(
      this as DeckListing,
    );
  }

  Map<String, dynamic> toMap() {
    return DeckListingMapper.ensureInitialized().encodeMap<DeckListing>(
      this as DeckListing,
    );
  }
  ...
  @override
  String toString() {
    return DeckListingMapper.ensureInitialized().stringifyValue(
      this as DeckListing,
    );
  }
  ...
  bool operator ==(Object other) {
    return DeckListingMapper.ensureInitialized().equalsValue(
      this as DeckListing,
      other,
    );
  }
