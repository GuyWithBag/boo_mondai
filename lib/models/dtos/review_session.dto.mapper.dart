...
class ReviewSessionMapper extends SubClassMapperBase<ReviewSession> {
  ...
  static const Field<ReviewSession, String> _f$userId = Field(
    'userId',
    _$userId,
    key: r'user_id',
  );
  static String? _$deckId(ReviewSession v) => v.deckId;
  static const Field<ReviewSession, String> _f$deckId = Field(
    'deckId',
    _$deckId,
    key: r'deck_id',
    opt: true,
  ...
  static const Field<ReviewSession, DateTime> _f$startedAt = Field(
    'startedAt',
    _$startedAt,
    key: r'started_at',
  );
  static DateTime? _$completedAt(ReviewSession v) => v.completedAt;
  static const Field<ReviewSession, DateTime> _f$completedAt = Field(
    'completedAt',
    _$completedAt,
    key: r'completed_at',
    opt: true,
  ...
  static const Field<ReviewSession, int> _f$totalCards = Field(
    'totalCards',
    _$totalCards,
    key: r'total_cards',
  );
...
mixin ReviewSessionMappable {
  String toJson() {
    return ReviewSessionMapper.ensureInitialized().encodeJson<ReviewSession>(
      this as ReviewSession,
    );
  }

  Map<String, dynamic> toMap() {
    return ReviewSessionMapper.ensureInitialized().encodeMap<ReviewSession>(
      this as ReviewSession,
    );
  }
  ...
  @override
  String toString() {
    return ReviewSessionMapper.ensureInitialized().stringifyValue(
      this as ReviewSession,
    );
  }
  ...
  bool operator ==(Object other) {
    return ReviewSessionMapper.ensureInitialized().equalsValue(
      this as ReviewSession,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ReviewSessionMapper.ensureInitialized().hashValue(
      this as ReviewSession,
    );
  }
}
