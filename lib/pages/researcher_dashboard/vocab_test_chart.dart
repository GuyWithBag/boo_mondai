...
import 'package:boo_mondai/pages/researcher_dashboard/bar_histogram.dart';
import 'package:boo_mondai/pages/researcher_dashboard/empty_chart.dart';

class VocabTestChart extends StatelessWidget {
  final List<VocabularyTestResult> results;
  final int maxScore;

  const VocabTestChart({super.key, required this.results, required this.maxScore});
