...
mixin LocalImageCacheEntryMappable {
  ...
  LocalImageCacheEntryCopyWith<LocalImageCacheEntry, LocalImageCacheEntry,
      LocalImageCacheEntry> get copyWith => _LocalImageCacheEntryCopyWithImpl<
          LocalImageCacheEntry, LocalImageCacheEntry>(
      this as LocalImageCacheEntry, $identity, $identity);
  @override
  String toString() {
    return LocalImageCacheEntryMapper.ensureInitialized()
        .stringifyValue(this as LocalImageCacheEntry);
  }

  @override
  bool operator ==(Object other) {
    return LocalImageCacheEntryMapper.ensureInitialized()
        .equalsValue(this as LocalImageCacheEntry, other);
  }

  @override
  int get hashCode {
    return LocalImageCacheEntryMapper.ensureInitialized()
        .hashValue(this as LocalImageCacheEntry);
  }
}
