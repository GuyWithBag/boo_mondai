...
class DeckVoteMapper extends ClassMapperBase<DeckVote> {
  ...
  static const Field<DeckVote, String> _f$deckId =
      Field('deckId', _$deckId, key: r'deck_id');
  static String _$profileId(DeckVote v) => v.profileId;
  static const Field<DeckVote, String> _f$profileId =
      Field('profileId', _$profileId, key: r'profile_id');
  static int _$voteValue(DeckVote v) => v.voteValue;
  static const Field<DeckVote, int> _f$voteValue =
      Field('voteValue', _$voteValue, key: r'vote_value');
  static DateTime _$createdAt(DeckVote v) => v.createdAt;
  static const Field<DeckVote, DateTime> _f$createdAt =
      Field('createdAt', _$createdAt, key: r'created_at');
  static DateTime _$updatedAt(DeckVote v) => v.updatedAt;
  static const Field<DeckVote, DateTime> _f$updatedAt =
...
mixin DeckVoteMappable {
  String toJson() {
    return DeckVoteMapper.ensureInitialized()
        .encodeJson<DeckVote>(this as DeckVote);
  }

  Map<String, dynamic> toMap() {
    return DeckVoteMapper.ensureInitialized()
        .encodeMap<DeckVote>(this as DeckVote);
  }

  DeckVoteCopyWith<DeckVote, DeckVote, DeckVote> get copyWith =>
      _DeckVoteCopyWithImpl<DeckVote, DeckVote>(
          this as DeckVote, $identity, $identity);
  @override
  String toString() {
  ...
  bool operator ==(Object other) {
    return DeckVoteMapper.ensureInitialized()
        .equalsValue(this as DeckVote, other);
  }
