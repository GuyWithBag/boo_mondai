...
class DeckVoteReviewCommentEditLogMapper
  ...
  static DeckVoteReviewCommentEditLogMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = DeckVoteReviewCommentEditLogMapper._(),
      );
  ...
  static const Field<DeckVoteReviewCommentEditLog, String> _f$id = Field(
    'id',
    _$id,
  );
  static String _$commentId(DeckVoteReviewCommentEditLog v) => v.commentId;
  static const Field<DeckVoteReviewCommentEditLog, String> _f$commentId = Field(
    'commentId',
    _$commentId,
    key: r'comment_id',
  );
  static String _$editedBy(DeckVoteReviewCommentEditLog v) => v.editedBy;
  static const Field<DeckVoteReviewCommentEditLog, String> _f$editedBy = Field(
    'editedBy',
    _$editedBy,
    key: r'edited_by',
  );
  static String _$oldBody(DeckVoteReviewCommentEditLog v) => v.oldBody;
  static const Field<DeckVoteReviewCommentEditLog, String> _f$oldBody = Field(
    'oldBody',
    _$oldBody,
    key: r'old_body',
  );
  static String _$newBody(DeckVoteReviewCommentEditLog v) => v.newBody;
  static const Field<DeckVoteReviewCommentEditLog, String> _f$newBody = Field(
    'newBody',
    _$newBody,
    key: r'new_body',
  );
...
mixin DeckVoteReviewCommentEditLogMappable {
  ...
  DeckVoteReviewCommentEditLogCopyWith<
  ...
  bool operator ==(Object other) {
    return DeckVoteReviewCommentEditLogMapper.ensureInitialized().equalsValue(
      this as DeckVoteReviewCommentEditLog,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return DeckVoteReviewCommentEditLogMapper.ensureInitialized().hashValue(
      this as DeckVoteReviewCommentEditLog,
    );
  }
}
...
extension DeckVoteReviewCommentEditLogValueCopy<$R, $Out>
  ...
  get $asDeckVoteReviewCommentEditLog => $base.as(
    (v, t, t2) => _DeckVoteReviewCommentEditLogCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _DeckVoteReviewCommentEditLogCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _DeckVoteReviewCommentEditLogCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
