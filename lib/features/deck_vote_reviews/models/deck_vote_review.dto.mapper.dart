...
class DeckVoteReviewMapper extends ClassMapperBase<DeckVoteReview> {
  ...
  static const Field<DeckVoteReview, String> _f$deckId = Field(
    'deckId',
    _$deckId,
    key: r'deck_id',
  );
  static String _$userId(DeckVoteReview v) => v.userId;
  static const Field<DeckVoteReview, String> _f$userId = Field(
    'userId',
    _$userId,
    key: r'user_id',
  );
  ...
  static const Field<DeckVoteReview, int> _f$voteValueAtCreation = Field(
    'voteValueAtCreation',
    _$voteValueAtCreation,
    key: r'vote_value_at_creation',
  );
  static String _$title(DeckVoteReview v) => v.title;
  static const Field<DeckVoteReview, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: '',
  ...
  static const Field<DeckVoteReview, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  static DateTime _$updatedAt(DeckVoteReview v) => v.updatedAt;
  static const Field<DeckVoteReview, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
  );
  static CachedProfile? _$userProfile(DeckVoteReview v) => v.userProfile;
  static const Field<DeckVoteReview, CachedProfile> _f$userProfile = Field(
    'userProfile',
    _$userProfile,
    key: r'user_profile',
    opt: true,
...
mixin DeckVoteReviewMappable {
  String toJson() {
    return DeckVoteReviewMapper.ensureInitialized().encodeJson<DeckVoteReview>(
      this as DeckVoteReview,
    );
  }

  Map<String, dynamic> toMap() {
    return DeckVoteReviewMapper.ensureInitialized().encodeMap<DeckVoteReview>(
      this as DeckVoteReview,
    );
  }

  DeckVoteReviewCopyWith<DeckVoteReview, DeckVoteReview, DeckVoteReview>
  get copyWith => _DeckVoteReviewCopyWithImpl<DeckVoteReview, DeckVoteReview>(
    this as DeckVoteReview,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return DeckVoteReviewMapper.ensureInitialized().stringifyValue(
      this as DeckVoteReview,
    );
  }
  ...
  bool operator ==(Object other) {
    return DeckVoteReviewMapper.ensureInitialized().equalsValue(
      this as DeckVoteReview,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return DeckVoteReviewMapper.ensureInitialized().hashValue(
      this as DeckVoteReview,
    );
  }
}
...
class _DeckVoteReviewCopyWithImpl<$R, $Out>
  ...
  DeckVoteReview $make(CopyWithData data) => DeckVoteReview(
    ...
    voteValueAtCreation: data.get(
      #voteValueAtCreation,
      or: $value.voteValueAtCreation,
    ),
