...
class DeckVoteReviewEditLogMapper
  ...
  static const Field<DeckVoteReviewEditLog, String> _f$reviewId =
      Field('reviewId', _$reviewId, key: r'review_id');
  static String _$editedBy(DeckVoteReviewEditLog v) => v.editedBy;
  static const Field<DeckVoteReviewEditLog, String> _f$editedBy =
  ...
  static const Field<DeckVoteReviewEditLog, int> _f$oldVoteValueAtCreation =
      Field('oldVoteValueAtCreation', _$oldVoteValueAtCreation,
  ...
  static const Field<DeckVoteReviewEditLog, CachedProfile> _f$editorProfile =
      Field('editorProfile', _$editorProfile,
...
mixin DeckVoteReviewEditLogMappable {
  ...
  DeckVoteReviewEditLogCopyWith<DeckVoteReviewEditLog, DeckVoteReviewEditLog,
      DeckVoteReviewEditLog> get copyWith => _DeckVoteReviewEditLogCopyWithImpl<
          DeckVoteReviewEditLog, DeckVoteReviewEditLog>(
      this as DeckVoteReviewEditLog, $identity, $identity);
  @override
  String toString() {
    return DeckVoteReviewEditLogMapper.ensureInitialized()
        .stringifyValue(this as DeckVoteReviewEditLog);
  }

  @override
  bool operator ==(Object other) {
    return DeckVoteReviewEditLogMapper.ensureInitialized()
        .equalsValue(this as DeckVoteReviewEditLog, other);
  }

  @override
  int get hashCode {
    return DeckVoteReviewEditLogMapper.ensureInitialized()
        .hashValue(this as DeckVoteReviewEditLog);
  }
}
...
class _DeckVoteReviewEditLogCopyWithImpl<$R, $Out>
  ...
  DeckVoteReviewEditLog $make(CopyWithData data) => DeckVoteReviewEditLog(
      ...
      oldVoteValueAtCreation:
          data.get(#oldVoteValueAtCreation, or: $value.oldVoteValueAtCreation),
      newVoteValueAtCreation:
          data.get(#newVoteValueAtCreation, or: $value.newVoteValueAtCreation),
