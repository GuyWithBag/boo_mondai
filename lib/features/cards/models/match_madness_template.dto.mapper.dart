...
part of 'match_madness_template.dto.dart';
...
class MatchMadnessTemplateMapper
  ...
  static DateTime? _$deletedAt(MatchMadnessTemplate v) => v.deletedAt;
  static const Field<MatchMadnessTemplate, DateTime> _f$deletedAt =
      Field('deletedAt', _$deletedAt, key: r'deleted_at', opt: true);
  static DateTime? _$purgeAfter(MatchMadnessTemplate v) => v.purgeAfter;
  static const Field<MatchMadnessTemplate, DateTime> _f$purgeAfter =
