...
class ThemeOverrideMapper extends ClassMapperBase<ThemeOverride> {
  ...
  static const Field<ThemeOverride, int> _f$primaryColorValue = Field(
      'primaryColorValue', _$primaryColorValue,
      key: r'primary_color_value', opt: true);
  static String? _$fontFamily(ThemeOverride v) => v.fontFamily;
  static const Field<ThemeOverride, String> _f$fontFamily =
      Field('fontFamily', _$fontFamily, key: r'font_family', opt: true);
  static double? _$radiusScale(ThemeOverride v) => v.radiusScale;
  static const Field<ThemeOverride, double> _f$radiusScale =
      Field('radiusScale', _$radiusScale, key: r'radius_scale', opt: true);
  static double? _$spacingScale(ThemeOverride v) => v.spacingScale;
  static const Field<ThemeOverride, double> _f$spacingScale =
      Field('spacingScale', _$spacingScale, key: r'spacing_scale', opt: true);
  static double? _$textScale(ThemeOverride v) => v.textScale;
  static const Field<ThemeOverride, double> _f$textScale =
      Field('textScale', _$textScale, key: r'text_scale', opt: true);
  static bool? _$highContrast(ThemeOverride v) => v.highContrast;
  static const Field<ThemeOverride, bool> _f$highContrast =
      Field('highContrast', _$highContrast, key: r'high_contrast', opt: true);
...
mixin ThemeOverrideMappable {
  String toJson() {
    return ThemeOverrideMapper.ensureInitialized()
        .encodeJson<ThemeOverride>(this as ThemeOverride);
  }

  Map<String, dynamic> toMap() {
    return ThemeOverrideMapper.ensureInitialized()
        .encodeMap<ThemeOverride>(this as ThemeOverride);
  }
  ...
  ThemeOverrideCopyWith<ThemeOverride, ThemeOverride, ThemeOverride>
      get copyWith => _ThemeOverrideCopyWithImpl<ThemeOverride, ThemeOverride>(
          this as ThemeOverride, $identity, $identity);
  @override
  String toString() {
    return ThemeOverrideMapper.ensureInitialized()
        .stringifyValue(this as ThemeOverride);
  }

  @override
  bool operator ==(Object other) {
    return ThemeOverrideMapper.ensureInitialized()
        .equalsValue(this as ThemeOverride, other);
  }

  @override
  int get hashCode {
    return ThemeOverrideMapper.ensureInitialized()
        .hashValue(this as ThemeOverride);
  }
}
...
class _ThemeOverrideCopyWithImpl<$R, $Out>
  ...
  ThemeOverride $make(CopyWithData data) => ThemeOverride(
      primaryColorValue:
          data.get(#primaryColorValue, or: $value.primaryColorValue),
