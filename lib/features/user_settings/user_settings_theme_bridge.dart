  ...
  static ThemeVariant<AppTokens> _applyOverrides(
    ...
    final nextTokens = theme.tokens.copyWith(
      ...
      spacePanelPaddingSm: spacingScale == null
          ? null
          : theme.tokens.spacePanelPaddingSm * spacingScale,
      spacePanelGapLg: spacingScale == null
          ? null
          : theme.tokens.spacePanelGapLg * spacingScale,
      spacePanelGapMd: spacingScale == null
          ? null
          : theme.tokens.spacePanelGapMd * spacingScale,
      spacePanelGapSm: spacingScale == null
          ? null
          : theme.tokens.spacePanelGapSm * spacingScale,
      ...
      textSizeCardFront: textScale == null
          ? null
          : theme.tokens.textSizeCardFront * textScale,
      textSizeCardBackFront: textScale == null
          ? null
          : theme.tokens.textSizeCardBackFront * textScale,
      textSizeCardBackContent: textScale == null
          ? null
          : theme.tokens.textSizeCardBackContent * textScale,
    );
