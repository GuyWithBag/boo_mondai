...
class StoredMediaMapper extends ClassMapperBase<StoredMedia> {
  ...
  static const Field<StoredMedia, String> _f$localPath = Field(
    'localPath',
    _$localPath,
    key: r'local_path',
  );
  static String? _$remoteUrl(StoredMedia v) => v.remoteUrl;
  static const Field<StoredMedia, String> _f$remoteUrl = Field(
    'remoteUrl',
    _$remoteUrl,
    key: r'remote_url',
    opt: true,
  ...
  static const Field<StoredMedia, String> _f$mimeType = Field(
    'mimeType',
    _$mimeType,
    key: r'mime_type',
    opt: true,
  ...
  static const Field<StoredMedia, int> _f$byteSize = Field(
    'byteSize',
    _$byteSize,
    key: r'byte_size',
    opt: true,
  ...
  static const Field<StoredMedia, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  static DateTime _$updatedAt(StoredMedia v) => v.updatedAt;
  static const Field<StoredMedia, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
  );
...
mixin StoredMediaMappable {
  String toJson() {
    return StoredMediaMapper.ensureInitialized().encodeJson<StoredMedia>(
      this as StoredMedia,
    );
  }

  Map<String, dynamic> toMap() {
    return StoredMediaMapper.ensureInitialized().encodeMap<StoredMedia>(
      this as StoredMedia,
    );
  }
  ...
  @override
  String toString() {
    return StoredMediaMapper.ensureInitialized().stringifyValue(
      this as StoredMedia,
    );
  }
  ...
  bool operator ==(Object other) {
    return StoredMediaMapper.ensureInitialized().equalsValue(
      this as StoredMedia,
      other,
    );
  }
