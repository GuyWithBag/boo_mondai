...
class ImportExportBackupMapper extends ClassMapperBase<ImportExportBackup> {
  ...
  static const Field<ImportExportBackup, String> _f$operation = Field(
    'operation',
    _$operation,
  );
  static String _$type(ImportExportBackup v) => v.type;
  static const Field<ImportExportBackup, String> _f$type = Field(
    'type',
    _$type,
  );
  static String? _$entityId(ImportExportBackup v) => v.entityId;
  static const Field<ImportExportBackup, String> _f$entityId = Field(
    'entityId',
    _$entityId,
    key: r'entity_id',
    opt: true,
  ...
  static const Field<ImportExportBackup, String> _f$title = Field(
    'title',
    _$title,
  );
  static String _$payloadJson(ImportExportBackup v) => v.payloadJson;
  static const Field<ImportExportBackup, String> _f$payloadJson = Field(
    'payloadJson',
    _$payloadJson,
    key: r'payload_json',
  );
...
mixin ImportExportBackupMappable {
  ...
  ImportExportBackupCopyWith<
    ImportExportBackup,
    ImportExportBackup,
    ImportExportBackup
  >
  get copyWith =>
      _ImportExportBackupCopyWithImpl<ImportExportBackup, ImportExportBackup>(
        this as ImportExportBackup,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return ImportExportBackupMapper.ensureInitialized().stringifyValue(
      this as ImportExportBackup,
    );
  }
  ...
  bool operator ==(Object other) {
    return ImportExportBackupMapper.ensureInitialized().equalsValue(
      this as ImportExportBackup,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return ImportExportBackupMapper.ensureInitialized().hashValue(
      this as ImportExportBackup,
    );
  }
}
...
abstract class ImportExportBackupCopyWith<
  $R,
  $In extends ImportExportBackup,
  $Out
>
