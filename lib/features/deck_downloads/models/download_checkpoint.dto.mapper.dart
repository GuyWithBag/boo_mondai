...
class DownloadCheckpointMapper extends ClassMapperBase<DownloadCheckpoint> {
  ...
  static List<String> _$downloadedAttachmentIds(DownloadCheckpoint v) =>
      v.downloadedAttachmentIds;
  static const Field<DownloadCheckpoint, List<String>>
  _f$downloadedAttachmentIds = Field(
    'downloadedAttachmentIds',
    _$downloadedAttachmentIds,
    key: r'downloaded_attachment_ids',
    opt: true,
    def: const [],
  );
  ...
  final MappableFields<DownloadCheckpoint> fields = const {
    ...
    #downloadedAttachmentIds: _f$downloadedAttachmentIds,
    #status: _f$status,
  ...
  static DownloadCheckpoint _instantiate(DecodingData data) {
    return DownloadCheckpoint(
      ...
      downloadedAttachmentIds: data.dec(_f$downloadedAttachmentIds),
...
class _DownloadCheckpointCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>
  get downloadedAttachmentIds => ListCopyWith(
    $value.downloadedAttachmentIds,
    (v, t) => ObjectCopyWith(v, $identity, t),
    (v) => call(downloadedAttachmentIds: v),
  );
  @override
  $R call({
    String? deckId,
    ...
    FieldCopyWithData({
      ...
      if (downloadedAttachmentIds != null)
  ...
  DownloadCheckpoint $make(CopyWithData data) => DownloadCheckpoint(
    ...
    downloadedAttachmentIds: data.get(
      #downloadedAttachmentIds,
      or: $value.downloadedAttachmentIds,
    ),
