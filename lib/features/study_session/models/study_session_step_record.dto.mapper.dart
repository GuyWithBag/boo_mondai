...
class StudySessionStepRecordMapper
  ...
  static const Field<StudySessionStepRecord, String> _f$sessionId = Field(
    'sessionId',
    _$sessionId,
    key: r'session_id',
  );
  static String _$stepId(StudySessionStepRecord v) => v.stepId;
  static const Field<StudySessionStepRecord, String> _f$stepId = Field(
    'stepId',
    _$stepId,
    key: r'step_id',
  );
  static String _$studyCardId(StudySessionStepRecord v) => v.studyCardId;
  static const Field<StudySessionStepRecord, String> _f$studyCardId = Field(
    'studyCardId',
    _$studyCardId,
    key: r'study_card_id',
  );
  static int _$sequenceNumber(StudySessionStepRecord v) => v.sequenceNumber;
  static const Field<StudySessionStepRecord, int> _f$sequenceNumber = Field(
    'sequenceNumber',
    _$sequenceNumber,
    key: r'sequence_number',
  );
  static int _$attemptNumber(StudySessionStepRecord v) => v.attemptNumber;
  static const Field<StudySessionStepRecord, int> _f$attemptNumber = Field(
    'attemptNumber',
    _$attemptNumber,
    key: r'attempt_number',
  );
  static String _$userAnswer(StudySessionStepRecord v) => v.userAnswer;
  static const Field<StudySessionStepRecord, String> _f$userAnswer = Field(
    'userAnswer',
    _$userAnswer,
    key: r'user_answer',
  );
  static StudyRating _$rating(StudySessionStepRecord v) => v.rating;
  static const Field<StudySessionStepRecord, StudyRating> _f$rating = Field(
    'rating',
    _$rating,
  );
  static DateTime _$enteredAt(StudySessionStepRecord v) => v.enteredAt;
  static const Field<StudySessionStepRecord, DateTime> _f$enteredAt = Field(
    'enteredAt',
    _$enteredAt,
    key: r'entered_at',
  );
  static DateTime _$completedAt(StudySessionStepRecord v) => v.completedAt;
  static const Field<StudySessionStepRecord, DateTime> _f$completedAt = Field(
    'completedAt',
    _$completedAt,
    key: r'completed_at',
  );
...
mixin StudySessionStepRecordMappable {
  ...
  StudySessionStepRecordCopyWith<
    StudySessionStepRecord,
    StudySessionStepRecord,
    StudySessionStepRecord
  >
  get copyWith =>
      _StudySessionStepRecordCopyWithImpl<
        StudySessionStepRecord,
        StudySessionStepRecord
      >(this as StudySessionStepRecord, $identity, $identity);
  @override
  String toString() {
    return StudySessionStepRecordMapper.ensureInitialized().stringifyValue(
      this as StudySessionStepRecord,
    );
  }

  @override
  bool operator ==(Object other) {
    return StudySessionStepRecordMapper.ensureInitialized().equalsValue(
      this as StudySessionStepRecord,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return StudySessionStepRecordMapper.ensureInitialized().hashValue(
      this as StudySessionStepRecord,
    );
  }
}
...
extension StudySessionStepRecordValueCopy<$R, $Out>
  ...
  get $asStudySessionStepRecord => $base.as(
    (v, t, t2) => _StudySessionStepRecordCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
