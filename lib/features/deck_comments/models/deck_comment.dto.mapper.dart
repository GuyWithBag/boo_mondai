...
class DeckCommentMapper extends ClassMapperBase<DeckComment> {
  ...
  static const Field<DeckComment, String> _f$deckId = Field(
    'deckId',
    _$deckId,
    key: r'deck_id',
  );
  static String _$userId(DeckComment v) => v.userId;
  static const Field<DeckComment, String> _f$userId = Field(
    'userId',
    _$userId,
    key: r'user_id',
  );
  ...
  static const Field<DeckComment, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
  static DateTime _$updatedAt(DeckComment v) => v.updatedAt;
  static const Field<DeckComment, DateTime> _f$updatedAt = Field(
    'updatedAt',
    _$updatedAt,
    key: r'updated_at',
  );
  static CachedProfile? _$userProfile(DeckComment v) => v.userProfile;
  static const Field<DeckComment, CachedProfile> _f$userProfile = Field(
    'userProfile',
    _$userProfile,
    key: r'user_profile',
    opt: true,
...
mixin DeckCommentMappable {
  String toJson() {
    return DeckCommentMapper.ensureInitialized().encodeJson<DeckComment>(
      this as DeckComment,
    );
  }

  Map<String, dynamic> toMap() {
    return DeckCommentMapper.ensureInitialized().encodeMap<DeckComment>(
      this as DeckComment,
    );
  }
  ...
  @override
  String toString() {
    return DeckCommentMapper.ensureInitialized().stringifyValue(
      this as DeckComment,
    );
  }
  ...
  bool operator ==(Object other) {
    return DeckCommentMapper.ensureInitialized().equalsValue(
      this as DeckComment,
      other,
    );
  }
