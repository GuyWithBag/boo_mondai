...
mixin DeckCommentEditLogMappable {
  ...
  DeckCommentEditLogCopyWith<DeckCommentEditLog, DeckCommentEditLog,
          DeckCommentEditLog>
      get copyWith => _DeckCommentEditLogCopyWithImpl<DeckCommentEditLog,
          DeckCommentEditLog>(this as DeckCommentEditLog, $identity, $identity);
  @override
  String toString() {
    return DeckCommentEditLogMapper.ensureInitialized()
        .stringifyValue(this as DeckCommentEditLog);
  }

  @override
  bool operator ==(Object other) {
    return DeckCommentEditLogMapper.ensureInitialized()
        .equalsValue(this as DeckCommentEditLog, other);
  }

  @override
  int get hashCode {
    return DeckCommentEditLogMapper.ensureInitialized()
        .hashValue(this as DeckCommentEditLog);
  }
}
...
abstract class DeckCommentEditLogCopyWith<$R, $In extends DeckCommentEditLog,
