...
class SurveyResponseMapper extends ClassMapperBase<SurveyResponse> {
  ...
  static const Field<SurveyResponse, String> _f$userId = Field(
    'userId',
    _$userId,
    key: r'user_id',
  );
  static String _$surveyType(SurveyResponse v) => v.surveyType;
  static const Field<SurveyResponse, String> _f$surveyType = Field(
    'surveyType',
    _$surveyType,
    key: r'survey_type',
  );
  static String? _$timePoint(SurveyResponse v) => v.timePoint;
  static const Field<SurveyResponse, String> _f$timePoint = Field(
    'timePoint',
    _$timePoint,
    key: r'time_point',
    opt: true,
  ...
  static const Field<SurveyResponse, Map<String, dynamic>> _f$responses = Field(
    'responses',
    _$responses,
  );
  ...
  static const Field<SurveyResponse, CachedProfile> _f$userProfile = Field(
    'userProfile',
    _$userProfile,
    key: r'user_profile',
    opt: true,
...
class _SurveyResponseCopyWithImpl<$R, $Out>
  ...
  ResearchProfileCopyWith<$R, ResearchProfile, ResearchProfile>?
  get researchProfile =>
      $value.researchProfile?.copyWith.$chain((v) => call(researchProfile: v));
  @override
  $R call({
    String? id,
    String? userId,
