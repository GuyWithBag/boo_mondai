...
import 'package:boo_mondai/lib.barrel.dart'
    show DrillAnswer, SupabaseRemoteDB, DrillAnswerMapper;
...
const _drillAnswerWithRelationsSelect =
    '*, session:drill_sessions(*, deck:decks(*), user_profile:profiles!drill_sessions_user_id_fkey(id, username, avatar_url, created_at)), card_template:card_templates(*, tags(*), options:multiple_choice_options(*), segments:fill_in_the_blank_segments(*), pairs:match_madness_pairs!match_madness_pairs_template_id_fkey(*))';
